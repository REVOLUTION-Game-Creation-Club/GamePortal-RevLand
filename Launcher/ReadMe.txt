========================================================================
		ActiveX Control DLL : LAUNCHER
========================================================================

ControlWizard has created this project for your LAUNCHER ActiveX Control
...
that make up your LAUNCHER ActiveX Control DLL.
...
LauncherCtl.h
	This file contains the declaration of the CLauncherCtrl C++ class.

LauncherCtl.cpp
	This file contains the implementation of the CLauncherCtrl C++ class.

LauncherPpg.h
	This file contains the declaration of the CLauncherPropPage C++ class.

LauncherPpg.cpp
	This file contains the implementation of the CLauncherPropPage C++ class.

LauncherCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CLauncherCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Launcher.rc.
